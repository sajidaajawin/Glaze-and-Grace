...
const ProductDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:8080/dashboard/allproducts')
      .then((response) => {
  ...
  const handleSaveEdit = (editedProduct) => {
    ...
    axios
      .put(`http://localhost:8080/dashboard/product/${editedProduct.id}/update`, editedProduct)
      .then((response) => {
  ...
  const handleAddProduct = (newProduct) => {
    axios
      .post('http://localhost:8080/dashboard/addproduct', newProduct)
      .then((response) => {
          ...
          <tbody>
            {displayedProducts.map((product) => (
              ...
              >
                ...
                <td className="p-2 text-sm">{product.counts}</td>
